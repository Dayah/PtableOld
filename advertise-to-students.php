<html>
 <head>
  <title>Advertise to College Students on this Periodic Table site</title>
  <style>
   H1, H2 {  border-bottom: thin solid black; }
   H1 { letter-spacing: -0.05em; font-family: Verdana, sans-serif; }
   H2 { letter-spacing: 0.05em; font-family: sans-serif; margin-left: 2em; }
   P { margin-left: 5em; }
  </style>
 </head>
 <body>
  ...
  <p>Internet banner advertising is a mess. When my periodic table first went live in 1997, web banner advertising was not a few pennies per click. It was often a penny or more per <strong>impression</strong>. And for good reason: an agency knew its audience and a publisher only provided one spot to one agency. It was a relationship.</p>
  ...
  <p>Expect at minimum (except for around Christmas and at the beginning of summer) five thousand views of your message per day. In the peak of the fall and spring semesters, <strong>expect 25,000 views on weekdays</strong>.</p>
  ...
  <h2>How much?</h2>
  <p>Paying for "clicks" rather than impressions evolved because advertisers didn't really know where their message was being shown or to whom. They could only be sure it worked if someone actually came to their site. This is not how highly directed, quality advertising works. Advertising with me will be paid for by impressions only. Banners are lucky to get half a percent clickthrough. My clickthrough ratio is close to 2%. A highly relevant text ad gets close to 4%.</p>

  <p>The specific CPM (cost per thousand impressions) is negotiable, though rates start at $10. Ask yourself how many pennies it's worth to your company for each student to see your message. Compare the price to taking out an ad in a college newspaper for a day. At a huge college, maybe 10,000 people will see your message&hellip;for how much? I am a web developer, not a businessman or an ad agency; <strong>offer me what you believe to be a fair rate for your advertising campaign and show me you are an honorable company and I will accept it.</strong></p>

  <p><a href="feedback.html">Make a proposal</a> or <a href="./">finish your homework</a>.</p>
