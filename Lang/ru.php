...
"Title" => FALSE,
"Periodic Table of Elements" => "Периодическая Система Элементов",
"Alkali metals" => "Щелочные металлы",
"Alkaline earth metals" => "Щёлочноземельные металлы",
"Transition metals" => "Переходные металлы",
"Lanthanide series" => "Лантаноиды",
"Actinide series" => "Актиноиды",
"Poor metals" => "Лёгкие металлы",
"Nonmetals" => "Неметаллы",
