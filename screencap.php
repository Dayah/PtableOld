<? if (array_key_exists("HTTP_IF_MODIFIED_SINCE", $_SERVER) && !strpos($_SERVER["HTTP_USER_AGENT"], "Googlebot")) { header("HTTP/1.1 304 Not Modified"); exit; }
require("Script/lang_detect.php"); date_default_timezone_set("America/New_York"); ?>
...
<html lang="<?= $visitor_accepted[0]["Named"] ?>">
 <head>
  ...
  <meta name="description" content="Large printable periodic table of elements with names for homework. Click an element for a full description. Includes PDF and image. Latest new elements.">
  <meta name="keywords" content="periodic table, elements, names, chemistry, printable, homework, pdf, electron configuration">

  <style type="text/css" media="screen, print">
<? include("Style/screen-default.css"); ?>
H1, .Alkali, .Alkaline, .Nonmetal, .Transition, .Actinide, .Lanthanide, .Poor, .Noble, .Hydrogen { background-image: none; }
  </style>
<? if (array_key_exists("scheme", $_GET) && $_GET["scheme"] == "dark") { ?>
  <link href="Style/screen-dark.css" rel="stylesheet" type="text/css" media="screen" title="Black background">
<? }
   if (array_key_exists("layout", $_GET) && $_GET["layout"] == "noelectron") { ?>
  <link href="Style/screen-noelectron.css" rel="stylesheet" type="text/css" media="screen, print" title="No electron config">
<? } ?>
...
<!--  <script src="http://www.google-analytics.com/urchin.js" type="text/javascript"></script><script type="text/javascript">_uacct = "UA-99745-1"; urchinTracker();</script> -->
 ...
 <body onLoad="window.frames['ElementFrame'].document.body.innerHTML = '<h1>Loading&hellip;</h1>';" style="margin: 0;">

 <h1 style="line-height: 1.1; font-size: 8.0em; margin-bottom: 1.3cm; width: 89.7%; margin-left: auto; margin-right: auto; margin-top: 0;"><?= local("Periodic Table of Elements") ?></h1>
  ...
  <table id="Main" summary="printable periodic table" cellspacing=0>
   ...
   <tr>
    ...
    <td></td>
    <td id="Stable" style="line-height: 5;" colspan=43><?= local("Parentheses") ?></td>
   ...
   <tr>
    ...
    <td class="InnerBorder" colspan=47 id="Copyright"><?= local("Copyright") ?> &copy; 1997 <a href="mailto:michael@dayah.com">Michael Dayah</a><span id=""> (michael@dayah.com). http://www.dayah.com/periodic/</span><span id="Print">. Last Modified: <?= date("F d, Y", getlastmod()) ?></span></td>
  ...
  <div id="ElementBox">
   <h1><table><tr><td id="Title"><span id="ElementName">Loading</span> - Periodic Table - <a id="FullArticle" href="http://en.wikipedia.org/">Open Wikipedia article in full screen</a></td><td id="Close" onClick="destroy(this);">Close</td></tr></table></h1>
